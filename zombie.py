...
class Zombie:
    ...
    def build_behavior_tree(self):
        ...
        chase_boy_if_nearby = Sequence('소년이 가까아 있으면 소년을 추적', c1, a4)

        chase_boy_if_nearby_or_wander = Selector('추적 아니면 배회', chase_boy_if_nearby, wander)

        a5 = Action('순찰 위치 가져오기', self.get_patrol_location)
        patrol = Sequence('순찰', a5, a2)

        root = chase_boy_if_nearby_or_patrol = Selector('추적 아니면 순찰', chase_boy_if_nearby, patrol)
